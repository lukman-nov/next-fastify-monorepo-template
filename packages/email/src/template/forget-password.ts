...
export const forgetPasswordTemplate = ({ url, t, user }: ForgetPasswordTemplate) => {
  const tBody = `
                  ...
                  <td>
                    <a href="${url}"
                      ...
                      <span style="max-width:100%;display:inline-block;line-height:120%;mso-padding-alt:0px;mso-text-raise:9px">
                        ${t('services.reset-password.button')}
                      </span>
                    </a>
                  </td>
                </tr>
              ...
              <tbody>
                <tr style="width:100%">
                  <td>
                    <p
                      style="font-size:14px;line-height:24px;margin:24px 0;color:#333;margin-bottom:25px;${fontFamily}">
                      ${t('services.reset-password.info-text')}
                    </p>
                  </td>
                </tr>
              </tbody>
  ...
  return baseTemplate({ title: t('services.reset-password.title'), tBody });
};
